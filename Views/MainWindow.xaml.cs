...
namespace TimeTrackerWPF.Views
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void AboutLinkOnClick(object sender, RoutedEventArgs e)
        {
        ...
        private void BrowseFilesOnClick(object sender, RoutedEventArgs e)
        {
            // Specify the path to the folder
            string folderPath = ProjectsFolderPath;
        ...
        {
            var quickActionWindow = new QuickActionWindow(ProjectsFolderPath);
        ...
        private void ViewSourceOnClick(object sender, RoutedEventArgs e)
        {
            ...
            OpenUrlInBrowser("https://github.com/killer6oose/TimeTrackerWPF");
        }
    }
}